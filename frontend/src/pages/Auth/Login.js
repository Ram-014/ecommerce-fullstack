  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>Login to your RamShop account</p>
        ...
        <div style={styles.demo}>
          <p style={styles.demoText}>Demo Admin: admin@shop.com / admin123</p>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  input: { width: '100%', padding: '10px 14px', border: '1px solid #d1d5db', borderRadius: '8px', fontSize: '15px', marginBottom: '16px', boxSizing: 'border-box', outline: 'none' },
  ...
  demo: { marginTop: '16px', background: '#f0f9ff', padding: '10px', borderRadius: '8px' },
  demoText: { fontSize: '12px', color: '#0369a1', margin: 0, textAlign: 'center' },
};
